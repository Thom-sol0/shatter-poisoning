...
class VNodeSharingPoison(VNodeSharingDefenseBase):
    """
    Median-based defense implementation
    """

    def initialize_defense_data(self):
        """
        Initialize median defense data structures
        """
        self.defense_data = {
    ...
    def defender_forward_averaging(self, data):
        """
        Collect parameter values for median-based aggregation
        """
    ...
    def get_defended_model(self):
        """
        Compute element-wise median for defense
        """
